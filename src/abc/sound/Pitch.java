...
public class Pitch {
    ...
    /**
     * Make the pitch sharp
     * @return new sharp pitch
     */
    public Pitch addSharp(){
        return transpose(1);
    }
    
    /**
     * Make pitch double sharp
     * @return new pitch
     */
    public Pitch addDoubleSharp(){
        return transpose(2);
    }
    
    /**
     * Make the pitch flat
     * @return new flat pitch
     */
    public Pitch addFlat(){
        return transpose(-1);
    }
    
    /**
     * Make pitch double flat
     * @return new pitch
     */
    public Pitch addDoubleFlat(){
        return transpose(-2);
    }
    
    /**
     * Add one octave
     * @return pitch with increased octave
     */
    public Pitch addOctave(){
        return transpose(12);
    }
    
    /**
     * Subtract one octave
     * @return pitch with decreased octave
     */
    public Pitch subtractOctave(){
        return transpose(-12);
    }
